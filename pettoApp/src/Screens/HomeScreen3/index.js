        ...
        renderItem={({item}) => (
          <>
            ...
            <View style={{left: 18, top: 18}}>
              <Text style={{fontSize: 16, fontWeight: '400', color: '#888888'}}>
                Pet Category
              </Text>
            </View>
            ...
            <View style={{flexDirection: 'row', left: 18, top: 28}}>
              <TouchableOpacity
                ...
                <View>
                  <Image
                    style={{width: 150, height: 131}}
                    source={ImagePath.raj}
                  />
                </View>
                <View>
                  <Text
              ...
              <TouchableOpacity>
                <View>
                  <Image
                    style={{width: 150, height: 131, left: 25}}
                    source={ImagePath.sandip}
                  />
                </View>
                <View>
                  <Text
