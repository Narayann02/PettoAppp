      ...
      <Modal transparent={true}>
        <View
          ...
          <ImageBackground
            ...
            source={ImagePath.Mask_circle}></ImageBackground>
          <Text
            style={{
              fontSize: 16,
              fontWeight: '400',
            ...
            Are you sure you want to end chat to Erica Brewster?
          </Text>
          <TouchableOpacity onPress={()=>navigation.navigate('addedfriend2')}>
            <ImageBackground
              style={{
                height: 50,
                width: 118,
